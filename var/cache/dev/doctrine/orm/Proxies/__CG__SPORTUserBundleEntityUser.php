...
namespace Proxies\__CG__\SPORT\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \SPORT\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nom', 'prenom', 'adresse', '' . "\0" . 'SPORT\\UserBundle\\Entity\\User' . "\0" . 'commandes', '' . "\0" . 'SPORT\\UserBundle\\Entity\\User' . "\0" . 'adresses', '' . "\0" . 'SPORT\\UserBundle\\Entity\\User' . "\0" . 'abonnements', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
